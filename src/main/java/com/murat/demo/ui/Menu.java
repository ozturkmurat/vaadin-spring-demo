...
import com.murat.demo.util.PSPulseHelper;
...
public abstract class Menu extends CssLayout {
	...
	public void addView(View view, final String name, String caption, Resource icon) {
		...
		PSPulseHelper helper = new PSPulseHelper();
		helper.getNavigator().addView(name, view);
	...
	public void addView(Class<? extends View> viewClass, final String name, String caption, Resource icon) {
		...
		PSPulseHelper helper = new PSPulseHelper();
		helper.getNavigator().addView(name, viewClass);
		createViewButton(name, caption, icon);
	}
	...
	private void createViewButton(final String name, String caption, Resource icon) {
		...
		Button button = new Button(caption, new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				PSPulseHelper helper = new PSPulseHelper();
				helper.getNavigator().navigateTo(name);
	...
	public abstract void populateHome();
	public abstract void populateNotification();
